                    ...
                    <div class="col-lg-12 col-xlg-12 col-md-12">
                        <div class="card">
                            ...
                            <ul class="nav nav-tabs profile-tab" role="tablist">
                               ...
                               <!--
<li class="nav-item">
    <a class="nav-link" data-toggle="tab" href="#social" role="tab" style="font-size: 14px;"> Social Media</a>
</li>
-->
...
-->
				                                ...
				                                <form class="row" action="Update" method="post" enctype="multipart/form-data">
                                                   ...
                                                   <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?>  <?php } else { ?> 
				                                    ...
				                                    <div class="form-group col-md-4 m-t-10">
				                                        <label>Next of Kin Contact N. </label>
...
-->
                                ...
                                <tr>
                                   ...
                                   <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?>
                                    ...
                                    <td class="jsgrid-align-center ">
                                       <a href="#" title="Edit" class="btn btn-sm btn-primary waves-effect waves-light education" data-id="<?php echo $value->id ?>" style="display:none;">
	                                    ...
	                                    <div class="card-body">
			                                <form class="row" action="Add_Education" method="post" enctype="multipart/form-data" id="insert_education">
			                                    ...
			                                    <div class="form-group col-md-6 m-t-5">
			                                        ...
			                                        <input type="text" name="name" class="form-control form-control-line" placeholder=" Degree Title / Certificate / Matric" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> minlength="1" required> 
			                                    </div>
			                                    <div class="form-group col-md-6 m-t-5">
			                                    ...
			                                    <div class="form-group col-md-6 m-t-5">
			                                        <label>Country</label>
			                                        <input type="text" name="result" class="form-control form-control-line" placeholder=" e.g., South Africa " minlength="2" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> required> 
			                                    </div>
			                                    <div class="form-group col-md-6 m-t-5">
			                                        <label> Year</label>
			                                        <input type="text" name="year" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> class="form-control form-control-line" placeholder=" Year"> 
			                                    </div>
			                                  <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?>
                                                    <?php } else { ?>
    ...
    <div class="card-body">
        <form class="row" action="Reset_Password_Hr" method="post" enctype="multipart/form-data">
            ...
            // Normalize for safe comparison: remove spaces and convert to uppercase
            $normalizedUserType = strtoupper(str_replace(' ', '', $userType));
            ...
            <?php } else { ?>
                <!-- Show message to non-Super Admin users -->
               
<div class="col-md-12">
    <p class="text-danger">
        Only TDH IT department can add or change passwords. Everyone else: hands off the keys! 🔑💻<br>
        Need help? Please email the IT department for assistance.
    </p>
</div>
...
?>
			                                   ...
			                                   <h3 class="card-title">Current Updated Info</h3>

			                                    <div class="row">
			                                    <!--
<div class="form-group col-md-6 m-t-5">
    <label>Deduction</label>
    <input type="text" name="bima" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> class="form-control form-control-line" placeholder="Deduction"<?php if(!empty($salaryvalue->bima)) echo $salaryvalue->bima ?>"> 
</div>
-->

			                                    <div class="form-group col-md-6 m-t-5">
			                                      <label>Borrow / Deductions</label>

			                                        <input type="text" name="tax" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> class="form-control form-control-line" placeholder="Borrow" value="<?php if(!empty($salaryvalue->tax)) echo $salaryvalue->tax ?>" > 
			                                    </div> 
                                                
			                                    <div class="form-group col-md-6 m-t-5">
			                                        <label>Net Salary</label>

			                                        <input type="text" name="provident" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> class="form-control form-control-line" placeholder="Net salary..." value="<?php if(!empty($salaryvalue->provident_fund)) echo $salaryvalue->provident_fund ?>"> 
			                                    </div>
			                                    <div class="form-group col-md-6 m-t-5">
			                                        <label>Updated by </label>
			                                        <input type="text" name="others" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> class="form-control form-control-line" placeholder="Please type your full name here ..." value="<?php if(!empty($salaryvalue->others)) echo $salaryvalue->others ?>"> 
			                                    </div>
                                                </div>
                                                <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?>
                                                    <?php } else { ?>
