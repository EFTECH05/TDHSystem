...
<div class="row page-titles">
   <div class="col-md-5 align-self-center">
      <h3 class="text-themecolor"><i class="fa fa-briefcase"></i> Promotion Announcements
      </h3>
   </div>
   <div class="col-md-7 align-self-center">
      <ol class="breadcrumb">
         ...
         <li class="breadcrumb-item active">Management Communications   
         </li>
      </ol>
   </div>
</div>
...
<div class="row m-b-10">
   <div class="col-12">
      ...
      <i class="" aria-hidden="true"></i>Send Communication to Management
      </a>
      </button>
   </div>
</div>
   ...
   <div class="col-12">
      <div class="card card-outline-info">
         <div class="card-header">
            <h4 class="m-b-0 text-white">Management Communications                   
            </h4>
         </div>
         <div class="card-body">
                     ...
                     <tr style="vertical-align:top">
                        ...
                        <td class="jsgrid-align-center">
                           ...
                           <?php if ($value->attendance_updated !== 'done' AND $value->status == 'Approved'): ?>
                               <a href="" id="closeAndUpdateFieldVisit" data-confirm="Are you sure want to close his field visit and update the ?" title="Mark as done" class="btn btn-sm btn-info waves-effect waves-light" data-id="<?php echo $value->id; ?>" data-employeeID="<?php echo $value->em_code; ?>">
                                <i class="fa fa-scissors"></i> Update 
                               </a>
                           <?php endif; ?>
                        </td>
                        <?php } ?>
   ...
   <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content ">
         <div class="modal-header">
            <h4 class="modal-title" id="exampleModalLabel1">Let’s Get Started
            </h4>
         ...
         <form method="post" action="Field_Application" id="fieldAuthForm" enctype="multipart/form-data">
            <div class="modal-body">
              ...
              <div class="col-md-6">
               ...
               <div class="form-group">
                  <label for="fieldLocation" class="control-label">Promotion Item Name</label>
                  <input type="text" class="form-control" placeholder="Promotion Item Name" name="fieldLocation">
               </div>
               <div class="form-group">
               ...
               <div class="form-group">
                  <label class="control-label">Additional Notes
                  </label>
                  <textarea name="notes" id="notes" class="form-control" rows="5"></textarea>
               </div>
               <div class="form-group" id="returnDate">
                  <label class="control-label">Actual  Date
                  </label>
